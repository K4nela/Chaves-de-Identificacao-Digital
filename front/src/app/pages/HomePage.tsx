  ...
  const funcionalidades = [
    {
      ...
      titulo: "Identificação Guiada",
      descricao: "Responda perguntas sequenciais e descubra a espécie passo a passo"
    },
    {
      icone: <Search className="w-6 h-6" />,
      titulo: "Busca por Filtros",
      descricao: "Filtre por Reino, Filo, Classe, Ordem, Família e Gênero"
    },
    {
      icone: <History className="w-6 h-6" />,
      titulo: "Histórico de Escolhas",
      descricao: "Suas respostas ficam salvas e você pode voltar em qualquer etapa"
    },
    {
      icone: <BookOpen className="w-6 h-6" />,
      titulo: "Informações Completas",
      descricao: "Receba classificação taxonômica completa com imagens e descrições"
    }
  ];
            ...
            >
              {beneficios.map((beneficio, indice) => (
                <motion.div
                  ...
                  transition={{ duration: 0.4, delay: 0.4 + indice * 0.1 }}
                >
